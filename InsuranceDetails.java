...
public class InsuranceDetails {
	...
	public double getPacover() {
		return pacover;
	}
	public void setPacover(double pacover) {
		this.pacover = pacover;
	}
	public int getNpassenger() {
		return npassenger;
	}
	public void setNpassenger(int npassenger) {
